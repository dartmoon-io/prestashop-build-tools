...
class HeaderStampCommand extends UpdateLicensesCommand
{
    ...
    const DEFAULT_IGNORED_FILES = ['index.php'];
    ...
    protected function getFinderFilter()//: \Closure
    {
        return function (\SplFileInfo $file) {
            return !in_array($file->getBasename(), self::DEFAULT_IGNORED_FILES);
        };
    }
}